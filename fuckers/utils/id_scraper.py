...
class WebSocket(websocket.WebSocketApp): 
    def __init__(self, token, guild_id, channel_id):
        ...
        self.socket_headers = {
            ...
            "User-Agent": 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) discord/1.0.82 Chrome/108.0.5359.215 Electron/22.3.26 Safari/537.36',
        }
        super().__init__(
            ...
            if decoded["t"] == "READY_SUPPLEMENTAL":
                ...
                if self.d == len(self.members):
                    ...
                    if self.iter == self.MAX_ITER:
                        print(f" Scraping  {len(self.members)} members")
...
def id_scraper(guild_id=None, channel_id=None):
    ...
    Output("info").log(f"Scraped {len(users)} ids")